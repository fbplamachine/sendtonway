...
<head>
	...
	<title>Administration - SendTonWay.com</title>
</head>
<body>
    ...
    <div class="navbarr">
        <div class="contain">
            <div class="logo">
                <a href="../index.php"><img src="../images/logo.png" alt="SendTonWay.com"></a>
            </div>
    	...
    	<div class="right" style="position: relative; right: 180px;">
    		...
    		<div style="float: left;">
    			<form id="form_tarifs" method="post" action="../php/modif_tarifs.php">
    				<div><label>Par KM:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="km" value="<?php echo $tarif[0]?>" disabled="true" id="chkm" required/>&nbsp;&nbsp;FCFA</div>
    				<div><label>Par KG:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="kg" value="<?php echo $tarif[1]?>" disabled="true" id="chkg" required/>&nbsp;&nbsp;FCFA</div>
    				<div><label>Par Taille:</label></div>
                    <div><label>Petit:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="pet" value="<?php echo $tarif[2]?>" disabled="true" id="chpt" required/>&nbsp;&nbsp;FCFA</div>
                    <div><label>Moyen:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="moy" value="<?php echo $tarif[3]?>" disabled="true" id="chmy" required/>&nbsp;&nbsp;FCFA</div>
                    <div><label>Grand:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="grd" value="<?php echo $tarif[4]?>" disabled="true" id="chgd" required/>&nbsp;&nbsp;FCFA</div>
                    <div><label>Très Grand:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="tgrd" value="<?php echo $tarif[5]?>" disabled="true" id="chtg" required/>&nbsp;&nbsp;FCFA</div>
    				<div><label>Par Difficulté:</label></div>
                    <div><label>Facil:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="fac" value="<?php echo $tarif[6]?>" disabled="true" id="chfac" required/>&nbsp;&nbsp;FCFA</div>
                    <div><label>Moyen:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="my" value="<?php echo $tarif[7]?>" disabled="true" id="chmoy" required/>&nbsp;&nbsp;FCFA</div>
                    <div><label>Difficil:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="diff" value="<?php echo $tarif[8]?>" disabled="true" id="chdiff" required/>&nbsp;&nbsp;FCFA</div>
    				<div><label>Demandes Spéciales:</label>&nbsp;&nbsp;&nbsp;<input type="number" step="0.01" min="0" name="spec" value="<?php echo $tarif[9]?>" disabled="true" id="chspec" required/>&nbsp;&nbsp;FCFA</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var css=".sidebar ul li a{background:#fff;} .sidebar ul li a:hover{background:#E02D05;}";
			...
			if (der==1) {
				...
				$("#infos").fadeIn();
				document.getElementById("tab_infos").style.background="#E02D05";
			...
			if (der==2) {
				...
				document.getElementById("ajout").style.display="none";
				$("#notifs").fadeIn();
				document.getElementById("tab_notifs").style.background="#E02D05";
			...
			if (der==3) {
				...
				document.getElementById("notifs").style.display="none";
				$("#ajout").fadeIn();
				document.getElementById("tab_ajout").style.background="#E02D05";
			...
			if (der==4) {
				...
				document.getElementById("ajout").style.display="none";
				$("#tarifs").fadeIn();
				document.getElementById("tab_tarifs").style.background="#E02D05";
