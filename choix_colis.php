              ...
              <div class="first">
                <div style="display:flex; flex-direction:row;" >
                  ...
                  if($row['photo']){
                   ...
                   $output .= ' <h4 class="text-danger" style=" display: flex ; justify-content: center;margin-top : 20px;">Prix : '.$row["tarif"].' FCFA </h3>
                  </div>
               ...
               $output .= '
                  ...
                  <div style="lign-height:0.5px;">
                   ...
                   if(mysqli_num_rows($result_choisir)>0){
                     $output .= '<input type="button" name="demander" id="'.$row['id_colis'].'" class="btn btn-primary demander mb-3" style ="color:#fff; background-color: #E02D05; " value="Choisi déja">';
                   }else{
                     $output .= '<input type="button" name="demander" id="'.$row['id_colis'].'" class="btn btn-primary demander mb-3" style ="color:#fff; background-color: #E02D05; " value="Choisir">';
                   } $output .= '
                 </div>
               </div>
                </div>
...
<head>
	...
	<title>Choisir Un Colis - SendTonWay.com</title><!--
            CSS
            ============================================= -->
