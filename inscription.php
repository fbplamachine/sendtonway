...
<html>
<head>
        <title>Inscription - SendTonWay.com</title>
...
<div class="input-group col-md-offset-3 down premium " >
                        <input type="button"  onclick="download(1)"name="s"id="down" style="background-color:#E02D05;" value="Telecharger le contrat">
...
<script  >
    function download(x){
            ...
            <!-- Submit button -->
        <div class="row y">
          <button type="submit" name="signup" id="signup"  style="background-color: #E02D05;"  class="center-block btn btn-primary btn-lg">Inscrire</button>
