...
<head>
    ...
    <title>Accueil - SendTonWay.com</title>
...
<div id="xs">
    ...
    <div class="cnx" style="z-index: 53;"><!--Connexion-->
        ...
        <form method="post" class="connex" action="php/login.php">
            <p id="eml" class="msg_err"
               style="color: #fff; font-size: 12px; margin-left: 30px; margin-top:-15px;display: none;">Veuillez
                vérifier votre e-mail!</p>
            <p id="mdp" class="msg_err"
               style="color: #fff; font-size: 12px; margin-left: 30px; margin-top:-15px; display: none;">Veuillez
                vérifier votre mot de passe!</p>
        ...
        <div><p class="insc">Vous n'avez pas de compte? <a href="inscription.php"><strong>Inscrivez-vous</strong></a>
            </p></div>
    </div>
    <div class="arrow"></div>
    ...
    <div id="full-slider-wrapper">
        <div id="layerslider" style="width:100%;height:473px;">
            ...
            <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
                ...
                <div class="ls-l videopreview" style="top:75px;left:-30px;white-space: nowrap;"
                     data-ls="offsetxin:-200;durationin:2000;offsetxout:-200;">
                    <img src="images/images.jpg" alt=""/>
                </div>

                <div class="ls-l" id="tt1" style="top:105px;left:70%;white-space: nowrap;"
                ...
                <div class="ls-l" id="dpart" style="top:225px;left:70%;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2" id="part"><b>PARTOUT AU CAMEROUN!</b></h2>
                </div>

                <div class="ls-l" style="top:305px;left:540px;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l3" id="quest">Vous voulez déposer une annonce?</h2>
                </div>

                <div class="ls-l" id="dconx2" style="top:318px;left:960px;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <a href="#" class="boutton1" id="conx2">Connectez-vous</a>
                </div>

                <div class="ls-l" id="dtra" style="top:340px;left:70%;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
            ...
            <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
                ...
                <div class="ls-l" style="top:15px;left:50%;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l1"><b>Découvrez nos services</b></h2>
                </div>

                <img src="images/services.png" alt="" class="ls-l videopreview"
                     style="width: 1000px;top:110px;left:50%;white-space: nowrap;"
                     data-ls="offsetxin:-200;durationin:2000;offsetxout:-200;"/>

                <div class="ls-l" style="top:200px;left:35px;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2" style="font-size: 32px;">Sécurisé</h2>
                </div>
                <div class="ls-l" style="top:200px;left:350px;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2" style="font-size: 32px;">Assuré</h2>
                </div>
                <div class="ls-l" style="top:200px;left:645px;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2" style="font-size: 32px;">Efficace</h2>
                </div>
                <div class="ls-l" style="top:200px;left:940px;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2" style="font-size: 24px;">Demandes<br>Spéciales</h2>
                </div>

                <div class="ls-l" style="top:270px;left:12px;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1500;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2" style="font-size: 16px;">Vos informations<br>ne s'afficheront que<br>pour les
                        personnes<br>que vous choisissez via<br>demande/acceptation</h2>
                </div>
                <div class="ls-l" style="top:270px;left:335px;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1500;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2" style="font-size: 16px;">Assurance<br>pour vos colis<br>en cas de perte<br>ou de
                        destruction</h2>
                </div>
                <div class="ls-l" style="top:270px;left:600px;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1500;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2" style="font-size: 16px;">Economisez votre<br>temps et votre<br>argent en
                        utilisant<br>le service de transportation<br>entre particuliers</h2>
                </div>
                <div class="ls-l" style="top:270px;left:915px;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1500;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2" style="font-size: 16px;">Votre colis demande<br>un maniement spécial?<br>Communiquez
                        cela<br>à votre transporteur<br>dans vos annonces<br></h2>
                </div>
            ...
            <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;" id="slideprem">
                ...
                <div class="ls-l" style="top:50px;left:50%;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <h2 class="l2">Obtenez plus de services exclusivement avec notre offre</h2>
                </div>

                <div class="ls-l" style="top:55%;left:50%;white-space: nowrap;"
                     data-ls="offsetxin:0;delayin:1500;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
                    <img src="images/prem.png" style="width:900px;">
                </div>

                <div class="ls-l" style="top:340px;left:50%;"
                     data-ls="offsetxin:0;delayin:2000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
...
<div class="aide"><!--Comment ca marche?-->
    ...
    <div class="container">
        ...
        <div class="gauche">
            <img src="images/t_1.png" height="400px" style="margin-top: 50px;" alt="" class="wow bounceInLeft animated"
                 data-wow-duration="1.5s" data-wow-offset="100"/>
        </div>
        ...
        <div class="droite">
            ...
            <h4 style="color: #187cc2;"><i class="fas fa-box"></i>&nbsp;&nbsp;Déposez votre annonce de colis:</h4>
            <p style="margin-left: 30px;">Remplissez un formulaire avec les informations nécessaires sur votre colis
                (lieux et dates d'envoie et du depôt, poids, taille... etc). Votre annonce s'affichera alors sur le
                site.</p>
            <h4 style="color: #187cc2;"><i class="fas fa-road"></i>&nbsp;&nbsp;Demandez des trajets:</h4>
            <p style="margin-left: 30px;">Recherchez et demandez les trajets que vous conviennent dans la page des
                annonces de trajets et attendez que votre transporteur accepte votre demande.</p>
            <h4 style="color: #187cc2;"><i class="fas fa-bell"></i>&nbsp;&nbsp;Recevez des demandes:</h4>
            <p style="margin-left: 30px;">Recevez des notifications et acceptez/refusez les demandes des transporteur
                pour transporter votre colis. Prenez garde de consulter la fiabilité de votre transporteur.</p>
            <h4 style="color: #187cc2;"><i class="fas fa-star"></i>&nbsp;&nbsp;Donnez un avis:</h4>
            <p style="margin-left: 30px;">Notez vos transporteurs et donnez votre avis sur votre experience sur le
                site.</p>

        </div>

        <div class="droite" style="width:390px;">
            <img src="images/t_2.png" height="400px" style="margin-top: 130px;" alt=""
                 class="wow bounceInRight animated" data-wow-duration="1.5s" data-wow-offset="100"/>
        </div>

        <div class="gauche" style="width:650px; margin-top: 50px;">
            <h3 style="color: #149310;">En tant que transporteur</h3>
            <h4 style="color: #149310;"><i class="fas fa-road"></i>&nbsp;&nbsp;Déposez votre annonce de trajet:</h4>
            <p style="margin-left: 30px;">Remplissez un formulaire avec les informations nécessaires sur votre trajet
                (lieux et dates du départ et d'arrivée, moyen de transport, arrêts, détour, poids et taille maximums...
                etc). Votre annonce s'affichera alors sur le site.</p>
            <h4 style="color: #149310;"><i class="fas fa-box"></i>&nbsp;&nbsp;Demandez des colis:</h4>
            <p style="margin-left: 30px;">Recherchez et demandez des colis pour transporter dans la page des annonces de
                colis et attendez que vos clients acceptent vos demandes.</p>
            <h4 style="color: #149310;"><i class="fas fa-bell"></i>&nbsp;&nbsp;Recevez des demandes:</h4>
            <p style="margin-left: 30px;">Recevez des notifications et acceptez/refusez les demandes de transportation
                de colis. Prenez garde de consulter la fiabilité de vos clients.</p>
            <h4 style="color: #149310;"><i class="fas fa-star"></i>&nbsp;&nbsp;Donnez un avis:</h4>
            <p style="margin-left: 30px;">Notez vos clients et donnez votre avis sur votre experience sur le site.</p>
        </div>
    </div>
</div>
...
<div class="aide propos"><!--A propos-->
    ...
    <div class="container">
        <div class="droite" style="width:390px;">
            <img src="images/images.jpg" height="200px" style="margin-top: 30px;" alt=""
                 class="wow bounceInRight animated" data-wow-duration="1.5s" data-wow-offset="100"/>
        </div>
        <div class="gauche">
            <h2><b>à propos</b></h2>
            ...
            <p style="margin-left: 30px; font-size: 16px;">Ce service était la première forme de livraision des colis.
                Il est devenue encore plus efficace grâce aux moyens de transports et de communication d'aujourd'hui.
                SendTonWay met en contact les voyageurs qui veulent rentabiliser leurs trajets avec les expéditeurs des
                colis avec le même trajet.</p>
        </div>
    ...
    <div class="container">
        ...
        <p style="text-align: center; font-size: 16px;">Nous sommes des jeunes entrepreneurs Camerounais qui de par nos
            embissions souhaitent participer à l'économie de notre cher beau pays le Cameroun.</p><br>

        <p style="text-align: center;">
            Lorem ipsum dolor sit amet, vim et vero copiosae instructior. Has meis posse vidisse an. Eu diam inciderint
            suscipiantur vim. Dicat assum verear eu nec. Ut legere principes consequat pro, ea docendi democritum his.
            Facer debet concludaturque id nec, labore facilisis no eum. Usu sonet mandamus at, ei vix sale homero
            cetero. Sea et saperet aliquando mediocritatem, et vim omnes nusquam explicari. Eum everti aperiam ut,
            malorum accusam mentitum ex mei.
        </p><br>
...
<div class="table" id="comp" style="background-image: linear-gradient(to bottom right, #E02D05, #F4633C);">
    <!--Table comparaison simple/premium-->
    <div id="prem"></div>
    <div class="container">
...
<div class="copy">
    <div class="container">
        ...
        <div class="copyright">Copyright © 2021 - <a href="index.php">SendTonWay.com</a></div>
...
<div id="voir_plus_notif_refuse" style="width: 20vw;max-height: 20vw;z-index: 50;height: 20vw;"
     class="col-md-4 col-md-offset-4">

    <span onclick='Closee()' class='glyphicon glyphicon-remove' id='remove'
          style='float:right;margin-right:1vw;'></span>
    </br>
...
<div id="insc_premium" class="col-md-4 col-md-offset-4" style="height:70%;">
    ...
    <div style="text-align: center;">
        ...
        <form action="./premium.php" method="POST" id='form' enctype="multipart/form-data">
            <h1 style="text-shadow:2px -1px 2px rgba(33,75,206,0.67);text-align: center;font-size: 200%;">Inscription
                premium</h1>
            <?php
    ...
    <p id="profile_img" class=" error_premium "></p>
            ...
            <span class="input-group-btn">
                <span class="btn btn-default btn-file">
                    Browse… <input type="file" name="img_carte" accept=".gif,.jpg,.jpeg,.png" id="img_carte"
                                   class="premium">
                </span>
            </span>
                        <input type="text" class="form-control prm_txt" readonly>
            ...
            <div class="input-group col-md-offset-3">
                <input type="button" onclick="download(1)" name="s" id="down" style="left:20px;"
                       value="Telecharger le contrat">
            ...
            <div class="row y">
                <button type="submit" name="signup" id="signup" style="background-color: #E02D05;"
                        class="center-block btn btn-primary btn-lg">Inscrire
                </button>
...
<script>
    $('#signup').click(function () {
        ...
        if (img_profile.value == '') {
            $('#form').submit(false);
            $("#profile_img").text("Veuillez choisir une photo de profile");
        } else {
            if (img_cart.value == '') {
                $('#form').submit(false);
                $("#carte_img").text("Veuillez inserer une photo de votre carte d'identité");
            } else {
                if (contra.value == '') {
                    $('#form').submit(false);
                    $("#contrat_pdf").text("Veuillez inserer le contrat rempli");
                } else {
                    $(document).ready(function () {
                        $("#form").submit();
                    });
...
<script>
    $('#sct').click(function () {
        ...
        if (email.value == '') {
            ...
            email.setCustomValidity('');
            if (password.value == '') {
                password.setCustomValidity('Veuillez remplir ce champs');
            } else {
                password.setCustomValidity('');
